...
Adapted from laya/email.py (Apache-2.0, Convai Innovations).
"""
...
def _strip_disclaimer(paragraph: str) -> str:
    ...
    A paragraph is dropped whole only when every sentence in it is boilerplate;
    otherwise only the boilerplate sentences go.
    """
